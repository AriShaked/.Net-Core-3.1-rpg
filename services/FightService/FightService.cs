    ...
    public class FightService: IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                var damage = DoSkillAttack(characterSkill, opponent);
        ...
        private static int DoSkillAttack(CharacterSkill characterSkill, Character opponent)
        {
            int damage = characterSkill.Skill.Damage - opponent.Defense;
                ...
                while (!defeated)
                {
                    foreach (Character attacker in characters)
                    {
                        ...
                        else
                        {
                            ...
                            damage = DoSkillAttack(attacker.CharacterSkills[randomSkill], opponent);
                        }
